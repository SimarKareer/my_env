...
LOCAL_PORT = 8045 
LOCAL_USERNAME = 'simarkareer'

if LOCAL_PORT is None or LOCAL_USERNAME == '':
    print("Please update LOCAL_PORT and LOCAL_USERNAME in ~/scripts/remote_tb.py")
    exit()

# Ports reserved for visualization from head node
